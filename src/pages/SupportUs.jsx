    ...
    <div className="w-full">
      ...
      <div className="flex mb-5 ">
        <a
          ...
          className="bg-gray-300 hover:bg-gray-400 py-3 px-5 rounded-lg mr-5 flex flex-col justify-center items-center bg-red-20"
        >
          <FaPaypal />
        ...
        <a
          ...
          className="bg-gray-300 hover:bg-gray-400 py-3 px-5 rounded-lg flex flex-col justify-center items-center"
        >
